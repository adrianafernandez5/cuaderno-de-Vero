...
# Utilizando el comando wc (word count), obtenemos 3 datos, lineas, palabras y caracteres. Para obtener solo las lineas, se utiliza el comando wc -l, separado por una barra vertical: gunzip -c DRR025089_2.fastq.gz | wc -l. Vemos que ambas secuencias tienen el mismo número de líneas.
:::
...
```
# Utilizamos less –c referencia.fa para verlo. Para saber las líneas que tiene, less –c referencia.fa | wc –l

:::{.callout-note icon=false}
## Preguntas
- ¿Crees que deberíamos guardar los archivos descargados en `../../data`?
# Yo los he guardado directamente en data, lo cual es mejor porque la carpeta data git la ignora, no queremos guardar datos. 
