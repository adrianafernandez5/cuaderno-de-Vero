...
## Añade una barra de escala que indica la distancia evolutiva.

axisPhylo(side = NULL, root.time = NULL, backward = TRUE)
## Añade un eje numérico que muestra la escala de distancias evolutivas.
```
...
¿Se corresponden bien las distancias evolutivas estimadas con las dataciones? Para responder hay que visualizar la regresión:
...
Cuál es la tasa de mutación global estimada? La tasa de mutación global corresponde a rate = 1.15857e-08

¿En qué unidades està expresada? Número de sustituciones por sitio
